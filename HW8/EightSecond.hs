...
runInteractive fileName = do
    ...
    if command == (T.pack "W") then
        ...
        do
            ...
            let propValue = getPropertyValue (T.drop 2 command) currentMap
...
getPropertyValue :: T.Text -> M.Map T.Text T.Text -> T.Text
getPropertyValue property m = do
