...
/* package HW11-0.1.0.0 */
#define VERSION_HW11 "0.1.0.0"
#define MIN_VERSION_HW11(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HW11-0.1.0.0-7PbMUDVNQwWFEoTWEjkqqS"

#define CURRENT_PACKAGE_KEY "HW11-0.1.0.0-7PbMUDVNQwWFEoTWEjkqqS"
